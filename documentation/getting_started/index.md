...
- [Open Echo Interface](documentation/getting_started/desktop_interface.md) - A desktop application that communicates with the Arduino, displays echo data as a real-time waterfall chart, and will soon allow runtime configuration of the system.
