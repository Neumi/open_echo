...
<img alt="LUCKY fishfinder pin hack" src="documentation/lucky_fishfinder/images/fishfinder_pins.JPG">

Measured results using LUCKY fishfinder, FastLOGIC (Arduino) and Matplotlib + Python:
<img alt="LUCKY fishfinder pin hack" src="documentation/lucky_fishfinder/images/echo_capture.jpg">
