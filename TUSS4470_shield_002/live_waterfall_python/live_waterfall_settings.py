...
DEFAULT_LEVELS = (0, 4096)  # Expected data range
                        ...
                        try:
                            ...
                            if sample_part.startswith("sp"):
                                ...
                                if values.shape[0] == NUM_SAMPLES:
                                    self.data_received.emit(values, depth_sample_number, temperature,
                                                            drive_voltage)  # Emit valid data
...
class WaterfallApp(QMainWindow):
    def __init__(self):
        ...
        layout.addWidget(self.drive_voltage_label)
