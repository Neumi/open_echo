...
serial_port = '/dev/tty.usbserial-1130' # Updated to the specified serial port
baud_rate = 1000000
...
num_samples = 650 # <Number of samples per measurement sequence
...
#sample_time = 113.2e-6  # 13.2 microseconds in seconds
